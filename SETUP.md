...
PRA VOCÊ RAFAELZINHO:

As variáveis estão no Doppler (doppler.com), projeto gymflow-s-org, ambiente dev.
Peça acesso ao José ou configure as suas próprias no .env.local.